    ...
    if wentback == False:
        if inp == str(syntax[0])+" "+str(syntax[1]):
            if syntax[1] in names: #cd dest
                ...
                if "bonus" in names_memory:
                    print(Fore.GREEN+Style.BRIGHT,files[0],end="         ")
                if "easteregg" in names_memory:
                    print(Fore.YELLOW+Style.BRIGHT,files[1],end="         ")
                if "readme" in names_memory:
                    print(Fore.WHITE+Style.NORMAL,files[2],end="         ")
                if "unknown" in names_memory:
                    print(Fore.RED+Style.BRIGHT,files[3],end="         ")
                print(Style.RESET_ALL)
                print(names)
                print(memory)
            ...
            if syntax[0] == "cd" and syntax[1] in names_memory: #cd (newdest)
                ...
                if syntax[1] == names[0]:
                    ...
                    if "unknown" in names[1]:
                        print(Fore.RED+Style.BRIGHT,files[3],end="         ")
                elif syntax[1] == names[2] and dirlen <= 3:
                    if "empty" in dir[2]:
                        print(Fore.YELLOW,"*"+Fore.WHITE,"Directory is empty",end="         ")
                        print(Style.RESET_ALL)
                        inp = input("player@termadventure ~ ")
                    ...
                    if "unknown" in names[2]:
                        print(Fore.RED+Style.BRIGHT,files[3],end="         ")
                elif syntax[1] == names[3] and dirlen <= 4:
                    if "empty" in dir[3]:
                        print(Fore.YELLOW,"*"+Fore.WHITE,"Directory is empty",end="         ")
                        print(Style.RESET_ALL)
                        inp = input("player@termadventure ~ ")
                    ...
                    if "unknown" in names[3]:
                        print(Fore.RED+Style.BRIGHT,files[3],end="         ")
                elif syntax[1] == names[4] and dirlen <= 5:
                    if "empty" in dir[4]:
                        print(Fore.YELLOW,"*"+Fore.WHITE,"Directory is empty",end="         ")
                        print(Style.RESET_ALL)
                        inp = input("player@termadventure ~ ")
                    ...
                    if "unknown" in names[4]:
                        print(Fore.RED+Style.BRIGHT,files[3],end="         ")
                elif syntax[1] == names[5] and dirlen <= 6:
                    if "empty" in dir[5]:
                        print(Fore.YELLOW,"*"+Fore.WHITE,"Directory is empty",end="         ")
                        print(Style.RESET_ALL)
                        inp = input("player@termadventure ~ ")
                    ...
                    if "unknown" in names[5]:
                        print(Fore.RED+Style.BRIGHT,files[3],end="         ")
                elif syntax[1] == names[6] and dirlen <= 7:
                    if "empty" in dir[6]:
                        print(Fore.YELLOW,"*"+Fore.WHITE,"Directory is empty",end="         ")
                        print(Style.RESET_ALL)
                        inp = input("player@termadventure ~ ")
