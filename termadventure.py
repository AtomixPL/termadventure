...
specialreadmetexts=["Linux kernel code: ","""
...
"""]
readmetexts=["here are some points for you: ","hello world","nothing to find here","thank you player, but the thing you're looking for is in another readme file!",
...
while True:
    ...
    while layer < 50:
        ...
        if wentbackempty == False:
            ...
            elif inp == str(syntax[3])+" readme" and "readme" in file: #readme files
                print(str(random.choice(readmetexts)))
                # readme=[]
                # kernelcode_chance = random.randint(1,15)
                # codex_chance = random.randint(1,15)
                # if kernelcode_chance < 13 or codex_chance < 13:
