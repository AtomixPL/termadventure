...
(executable) - run the program or claim bonus"""
        ...
        self.colors_map2 = {
            ...
            'm': Fore.BLUE,
            'a': Fore.MAGENTA}
        self.dirs=["bin","boot","dev","etc","lib","mnt","opt","proc","run","srv","sys","tmp","usr","var","dir","tux","linux","localhost","local","doc","share","tmpfs","home","udev","tty1","sbin","src",
        ...
        self.files=["bonus","easteregg","readme","readme2","readme3","unknown","codex","kernelcode","chroma","hex"]
        self.colors=["r","g","y","b","m","c"]
        self.ch=["c","h","r","o","m","a"]
        self.coloramas=[Fore.RED, Fore.GREEN, Fore.YELLOW, Fore.BLUE, Fore.MAGENTA, Fore.CYAN]
        self.specialreadmetexts=["Linux termadventure 6.15.5-zen1-1-zen x86_64 GNU/Linux",
        ...
        self.readmetexts=["hello world","nothing to find here","thank you player, but the thing you're looking for is in another readme file!",
        ...
        self.rootpasswords=["********","123","root","admin","password","administrator","linuxthebest","excalibur","opensesame"]
        self.bonuses = [1000,2000,3000,4000,5000]
